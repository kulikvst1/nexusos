    ...
    void resized() override
    {
        ...
        if (mainTab != nullptr)
        {
            ...
            //cpu indikator 
            {
                ...
                // Допустим, верхняя панель высотой 30 пикселей – используем её для размещения индикатора:
                auto topBar = totalArea.removeFromTop(30);

                // Зададим индикатору CPU загрузки прямоугольник, например, с шириной 100 и отступом:
                cpuLoadIndicator->setBounds(topBar.removeFromRight(100).reduced(2));
