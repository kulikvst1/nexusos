...
public:
    ...
    void releaseResources() override { audioDSP->releaseResources(); }

    void resized() override { multiMidiComp->setBounds(getLocalBounds()); }
...
private:
    ...
    MultiMidiSenderComponent* getMultiMidiSenderComponent() { return multiMidiComp; }
