...
public:
    ...
    PitchResult process(const float* x, int size) override
    {
        ...
        // NSDF (нормированна€ автокоррел€ци€ разности)
        ...
        // ѕоиск первого локального максимума выше порога
        const float thr = 0.6f; // можно 0.55Ц0.7
        ...
        // ѕараболическа€ интерпол€ци€ максимумa NSDF
        ...
        const float conf = std::clamp(bestVal, 0.0f, 1.0f); // пик NSDF как доверие
