...
private:
    ...
    // Обновление внешнего вида кнопки авто-фиксации
    void updateLockButtonAppearance() noexcept;
    ...
    juce::TextButton           lockButton{ "Auto-lock: ON" }; // текст/цвет обновляем динамически
    ...
    bool  autoStringLock = true;          // включить авто-фиксацию
