...
InputControlComponent::InputControlComponent()
{
    ...
    vuLeft.setCalibrationDb(+3.0f);
    vuRight.setCalibrationDb(+3.0f);
...
void InputControlComponent::processBlock(float* const* channels, int numSamples) noexcept
{
    ...
    meterLevelL.store(preEnvL, std::memory_order_release);
    meterLevelR.store(preEnvR, std::memory_order_release);
