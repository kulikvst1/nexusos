    ...
    : deviceManager(adm)
{
    ...
    activeLibraryLabel.setText("Library: none", juce::dontSendNotification);
...
void Rig_control::resized()
{
    ...
    {
        int labelW = bankRect.getWidth() / 4;
...
void Rig_control::updateActiveLibraryLabel()
{
    if (bankEditor)
    {
        ...
        activeLibraryLabel.setText("Library: " + libName, juce::dontSendNotification);
    }
}
//+++++++++++++++++++++++++++++ updatePluginLabel ++++++++++++++++++++++++++++++++++++++
...
void Rig_control::processMidiInput(int channel, int cc, int value, bool isOn, const juce::MidiMessage& msgCopy)
{
    ...
    // --- Looper control ---
    if (channel == 1 && cc == 20 && isOn && looperComponent) looperComponent->pressResetButton();
    if (channel == 1 && cc == 24 && isOn && looperComponent) looperComponent->pressControlButton();
