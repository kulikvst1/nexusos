...
void FileManager::updateUsbButtons(const juce::Array<juce::File>& removable)
{
    ...
    for (int i = 0; i < removable.size(); ++i)
    {
        ...
        auto* btn = new juce::TextButton(
            juce::String::fromUTF8("📀️") + makeDriveLabel(drive)
        );
    ...
    : currentMode(mode)
{
    ...
    copyButton.setButtonText(juce::String::fromUTF8("📋 Copy"));
    pasteButton.setButtonText(juce::String::fromUTF8("📥 Paste"));
    deleteButton.setButtonText(juce::String::fromUTF8("❌ Delete"));
    okButton.setButtonText(juce::String::fromUTF8("✔️ OK"));
    homeButton.setButtonText(juce::String::fromUTF8("🏠 Home"));
...
void FileManager::resized()
{
    ...
    // 🔹 Настройки для верхних кнопок (Home + USB)
...
void FileManager::deleteSelected()
{
    ...
    opts = opts.withIconType(juce::MessageBoxIconType::WarningIcon)
        .withTitle(juce::String::fromUTF8("🗑️ Confirm deletion"))
        .withMessage(message)
        .withButton(juce::String::fromUTF8("✔️ Yes"))
        .withButton(juce::String::fromUTF8("❌ No"));
