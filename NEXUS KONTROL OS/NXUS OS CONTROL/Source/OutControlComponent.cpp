...
OutControlComponent::OutControlComponent()
{
    ...
    gainSliderL.setColour(juce::Slider::trackColourId, juce::Colours::darkblue);
    ...
    gainSliderR.setColour(juce::Slider::trackColourId, juce::Colours::darkblue);
