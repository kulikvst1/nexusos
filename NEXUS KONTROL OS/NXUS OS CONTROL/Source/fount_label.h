...
class BigFontComboBoxLFq : public juce::LookAndFeel_V4
{
public:
    BigFontComboBoxLFq() {}

    // Шрифт в самом ComboBox (адаптивный от высоты)
    juce::Font getComboBoxFont(juce::ComboBox& box) override
    {
    ...
    // Подстроить высоту и ширину пунктов меню под крупный шрифт
