...
/** Возвращает индекс текущего (активного) пресета. */
    ...
    // ────────────────────────── новое публичное API ──────────────────────────///////////////////////////////////learn
    void startLearn(int slotIndex);   // включить режим Learn для CC-слота
    void cancelLearn();                // отменить режим Learn
...
private:
   ...
   // void resetAllCCStates();//////////////////////
    ...
    bool        isLearning = false;   // сейчас активен режим Learn?
    int         learnSlotIdx = -1;      // индекс CC-слота, который «учим»
    juce::Colour oldLearnColour;        // чтобы вернуть оригинальный цвет
    //////////////////////////////////////////////////////////////////////////////////////////////
