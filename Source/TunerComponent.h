...
public:
    ...
    /**
     * Callback invoked whenever referenceA4 is changed by user interaction.
     * Can be bound to synchronize multiple TunerComponent instances.
     */
    std::function<void(double)> onReferenceA4Changed;

    /**
     * Sets the reference A4 frequency.
     * @param a4Hz             New A4 in Hz.
     * @param notifyCallback   If true, calls onReferenceA4Changed(a4Hz).
     */
