...
public:
    enum MenuIds {
        ...
        miTotalMixFX,
        miLoadDefaultOnStartup, miAutoSwitchRig // ← новый пункт
    };
...
private:
    ...
    std::unique_ptr<juce::Drawable> iconFscreen, iconconfig, iconvstManager,
        ...
        iconKey, iconKeyOff, iconUpdate, iconclose, iconPowerOff, iconTotalMix, iconDefLoad, iconDefLoadOFF,iconBackRig, iconBackRigOFF;
    ...
    void loadWindowState()
    {
        ...
        if (xml != nullptr)
        {
            ...
            // 🔹 восстановление состояния Auto-switch to RIG Control
    ...
    void saveWindowState()
    {
        ...
        // 🔹 сохраняем флаг Auto-switch to RIG Control
